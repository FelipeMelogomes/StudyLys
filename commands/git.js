...
const exampleEmbed = new EmbedBuilder()
	...
	.setThumbnail('https://i.imgur.com/eie9guX.png')
	.addFields(
		{ name: '\u200B', value: '\u200B' },
		...
		{ name: '$ git commit-m"[mensagem]"', value: 'Grava o snapshot permanente do arquivo no histórico de versão', inline: true },
		{ name: '\u200B', value: '\u200B' },
		{ name: '$ git branch', value: 'Lista todos o branches locais no repositório atual', inline: true },
		{ name: '$ git branch [nome-branch]', value: 'Cria uma nova branch', inline: true },
		{ name: '$ git git-switch-c [nome-branch', value: 'Muda para a branch especificada e atualiza o diretório de trabalho', inline: true },
		{ name: '\u200B', value: '\u200B' },
